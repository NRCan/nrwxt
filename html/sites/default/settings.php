 ...
 * @endcode
 */
$settings['hash_salt'] = 'tJOwdTpHN9PEDilgmd0NFotfCvBJjRvkes5ihv-soQ1EydsQEBl8OMhL4iuf30qyCE3mf9PWGA';
...
$settings['reverse_proxy_addresses'] = ['169.254.131.1'];
...
$settings['redis.connection']['port'] = intval(getenv('REDIS_PORT'));
